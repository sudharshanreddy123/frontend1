...
public class ShoppingCartException {
	...
	private static final Logger logger = LoggerFactory.getLogger(ShoppingCartException.class);
	...
	public ModelAndView noHandlerException(HttpServletRequest request, Exception e){
		...
		mav.addObject("message","No handler found please contact administrtion");
